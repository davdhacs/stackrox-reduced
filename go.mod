...
require (
	...
	github.com/stackrox/scanner v2.1.4-stackrox+incompatible
...
require (
	...
	github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/containerservice/armcontainerservice/v8 v8.1.0 // indirect
